...
describe('BookTitle', () => {
  ...
  describe('formatting and special characters', () => {
    it('should maintain special characters and spaces', () => {
      const title = new BookTitle('Design Patterns: Elements of Reusable Object-Oriented Software');
      expect(title.value).toBe('Design Patterns: Elements of Reusable Object-Oriented Software');
    });
