...
describe('CreateArticle', () => {
  ...
  it('should create article with valid data', async () => {
    ...
    const savedArticle = (repository.save as jest.Mock).mock
    ...
    expect(savedArticle.bookIds.getValue()).toEqual([
      'dd7d8194-e099-4e3a-a431-6b4412dc5f6b',
    ])
  ...
  it('should throw error when id already exists', async () => {
    ...
    ).rejects.toThrow(ArticleIdDuplicated)
  })
  ...
  it('should throw error on invalid UUID format', async () => {
    ...
    ).rejects.toThrow('Invalid UUID v4 format')
  })
})
