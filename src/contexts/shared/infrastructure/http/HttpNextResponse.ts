...
export class HttpNextResponse {
  ...
  static badRequest(
    ...
    const response =
      typeof error === 'string' ? { type: 'BadRequest', message: error } : error
  ...
  static forbidden(
    ...
    const response =
      typeof error === 'string' ? { type: 'Forbidden', message: error } : error
  ...
  static unauthorized(
    ...
    const response =
      typeof error === 'string'
        ? { type: 'Unauthorized', message: error }
        : error
  ...
  static notFound(
    ...
    const response =
      typeof error === 'string' ? { type: 'NotFound', message: error } : error
  ...
  static conflict(
    ...
    const response =
      typeof error === 'string' ? { type: 'Conflict', message: error } : error
