...
export class ArticleRelatedLinkMother {
  ...
  static withFragment(): ArticleRelatedLink {
    return ArticleRelatedLink.create('Example Link', 'https://example.com/path#section');
  }
  ...
  static withQueryParams(): ArticleRelatedLink {
    return ArticleRelatedLink.create('Example Link', 'https://example.com?param=value');
  }
