...
test.describe('Protected Routes', () => {
  ...
  test('should allow access to auth endpoints without token', async ({ request }) => {
  ...
  test('should reject access to articles without token', async ({ request }) => {
  ...
  test('should reject access with invalid token format', async ({ request }) => {
    const response = await request.get('/api/backoffice/articles', {
      headers: {
  ...
  test('should allow access to articles with valid token', async ({ request }) => {
    const response = await request.get('/api/backoffice/articles', {
      headers: {
